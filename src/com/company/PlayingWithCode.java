...
public class PlayingWithCode {
    public static void main(String[] args) {
       ...
       String[] numberTrue = { "9","123","193","(123)","(234)","129 abf","873-(456)","129 abf","129 abf","123 abc","+1 11","123-ABC","123 456 xyz","123-456-XYZ","123 456-789","123-456 789","123 45-up-89","(123) 456","123-(456)","123 (456) 789","123-(456)-789","(123) 456-789","(123)-456 789","123 (45)-67-89","123-566-XYZ","123 456-349","134-456 789","123 45-down-89","(123) 566","123 (786) 789","163-(456)-789","(123) 496-789","(173)-456 789","123 (95)-67-89","+(another)","+(phone)"};
//        String[] numberTrue = { "9","123","193","(123)","(234)","129 abf","873-(456)","129 abf","129 abf","123 abc","+1 11","123-ABC","123 456 xyz","123-456-XYZ","123 456-789","123-456 789","123 45-up-89","(123) 456,123-(456)","123 (456) 789","123-(456)-789","(123) 456-789","(123)-456 789","123 (45)-67-89","123-566-XYZ","123 456-349","134-456 789","123 45-down-89","(123) 566","123 (786) 789","163-(456)-789","(123) 496-789","(173)-456 789","123 (95)-67-89","+(another)","+(phone)"};
        ...
        for (String num: numberTrue) {
            System.out.print(num.matches("(.\\([a-zA-Z]{7}\\))")|num.matches("(.\\([a-zA-Z]{5}\\))") | num.matches("^([0-9]{3}) ([0-9]{2})-([a-zA-Z]{4})-([0-9]{2})")|num.matches("^([0-9]{3}) \\(\\d{2}\\)-([0-9]{2})-([0-9]{2})")|num.matches("^([0-9]{3}) ([0-9]{2})-([a-zA-Z]{2})-([0-9]{2})")|num.matches("^\\+\\d{1} \\d{2}$")|num.matches("^\\d{1}$")|num.matches("^\\d{3}$")|num.matches("\\(\\d{3}\\)")|num.matches("^([0-9]{3}) ([a-zA-Z]{3})$")|num.matches("^([0-9]{3})-\\(\\d{3}\\)$")|num.matches("^\\(\\d{3}\\) ([0-9]{3})$")|num.matches("^\\(\\d{3}\\) ([0-9]{3})-([0-9]{3})$")|num.matches("^\\(\\d{3}\\)-([0-9]{3}) ([0-9]{3})$")|num.matches("^([0-9]{3})-\\(\\d{3}\\)$")|num.matches("^([0-9]{3}) \\(\\d{3}\\) ([0-9]{3})$")|num.matches("^([0-9]{3})-\\(\\d{3}\\)-([0-9]{3})$")|num.matches("^([0-9]{3})-([a-zA-Z]{3})$")|num.matches("^([0-9]{3}) ([0-9]{3}) ([a-zA-Z]{3})$")|num.matches("^([0-9]{3}) ([0-9]{3})-([0-9]{3})$")|num.matches("^([0-9]{3})-([0-9]{3})-([a-zA-Z]{3})$")|num.matches("^([0-9]{3})-([0-9]{3}) ([0-9]{3})$")); //"+(another)"
